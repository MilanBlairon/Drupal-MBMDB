    ...
    ";
        ...
        ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["tray"] ?? null), "label", [], "any", false, false, true, 31)) {
                ...
                yield "\"><h3 class=\"toolbar-tray-name visually-hidden\">";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["tray"] ?? null), "label", [], "any", false, false, true, 32), "html", null, true);
                yield "</h3>";
            } else {
                // line 34
            ...
            // line 36
            yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, ($context["tray"] ?? null), "links", [], "any", false, false, true, 36), "html", null, true);
            // line 37
            yield "</nav></div>
      </div>
    ";
...
";
    ...
    {
        return array (  100 => 41,  97 => 40,  89 => 37,  87 => 36,  84 => 34,  77 => 32,  75 => 31,  71 => 30,  69 => 29,  64 => 28,  61 => 27,  57 => 26,  53 => 25,  49 => 24,  44 => 23,);
    }
